...
export const authRoutes = [ // массив для хранения маршрутов, к которым имеет доступ только авторизованный пользователь
    {
...
export const publicRoutes = [ // массив для хранения маршрутов, к которым имеет доступ любой пользователь
    {
        path: SHOP_ROUTE, 
        Component: Shop 
    },
